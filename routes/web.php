 ...
 * Product Routes
 */
Route::get('/Product','ProductCrontroller@show')->name('product.show');
Route::post('/Product-getData','ProductCrontroller@getData')->name('product.getdata');
Route::post('/Product-insert','ProductCrontroller@insert')->name('product.insert');
Route::post('/Product-edit','ProductCrontroller@edit')->name('product.edit');
Route::post('/Product-update/{id}','ProductCrontroller@update')->name('product.update');


/*
 * sell Routes
 */
Route::get('/Sell','SellController@show')->name('sell.show');
Route::post('/Sell-getData','SellController@getData')->name('sell.getdata');
Route::post('/Sell-insert','SellController@insert')->name('sell.insert');
